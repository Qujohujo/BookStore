...
namespace BookStore.Models
{
    public class SessionCart : Cart
    {
        ...
        //contains methods to override the Cart class that it inherits from
        public override void AddItem(Book book, int quantity) 
        { 
            base.AddItem(book, quantity); Session.SetJson("Cart", this);
        }
        
        public override void RemoveLine(Book book)
        {
            base.RemoveLine(book); Session.SetJson("Cart", this);
        }
